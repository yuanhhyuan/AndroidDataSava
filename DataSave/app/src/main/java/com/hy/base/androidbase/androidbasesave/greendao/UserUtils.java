...
public class UserUtils {
    ...
    public  void insert(User mUser) {
        MyApplication.getDaoSession().getUserDao().insertOrReplace(mUser);
    }
    ...
    public  void delete(long id) {
        MyApplication.getDaoSession().getUserDao().deleteByKey(id);
    }
    ...
    public  void update(User mUser) {
        MyApplication.getDaoSession().getUserDao().update(mUser);
    }
    ...
    public  List<User> queryUser(String name) {
        return MyApplication.getDaoSession().getUserDao().queryBuilder().where(UserDao.Properties.Name.eq(name)).list();
    ...
    public  List<User> queryAll() {
        ...
        if(MyApplication.getDaoSession().getUserDao()!=null){
            mUser = MyApplication.getDaoSession().getUserDao().loadAll();
        }
